...
func (v *formatter_) PreprocessModuleDeclaration(
	moduleDeclaration ast.ModuleDeclarationLike,
) {
	// TBD - Add formatting of the delimited rule.
}

func (v *formatter_) ProcessModuleDeclarationSlot(
	slot uint,
) {
	// TBD - Add formatting of the delimited rule.
}

func (v *formatter_) PostprocessModuleDeclaration(
	moduleDeclaration ast.ModuleDeclarationLike,
) {
	// TBD - Add formatting of the delimited rule.
}

func (v *formatter_) PreprocessModuleHeader(
	moduleHeader ast.ModuleHeaderLike,
) {
	// TBD - Add formatting of the delimited rule.
}

func (v *formatter_) ProcessModuleHeaderSlot(
	slot uint,
) {
	// TBD - Add formatting of the delimited rule.
}

func (v *formatter_) PostprocessModuleHeader(
	moduleHeader ast.ModuleHeaderLike,
) {
	// TBD - Add formatting of the delimited rule.
}

func (v *formatter_) PreprocessModuleImports(
	moduleImports ast.ModuleImportsLike,
) {
	// TBD - Add formatting of the delimited rule.
}

func (v *formatter_) ProcessModuleImportsSlot(
	slot uint,
) {
	// TBD - Add formatting of the delimited rule.
}

func (v *formatter_) PostprocessModuleImports(
	moduleImports ast.ModuleImportsLike,
) {
	// TBD - Add formatting of the delimited rule.
}
